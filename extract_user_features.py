...
def kmeans_thetas(num_users, d, n_clusters, filename):
    ...
    # Ensure all entries in thetas lie between 0 and 1
    thetas = np.clip(thetas, 0, 1)
...
U = ExtractUserFeatures(num_users=1000, d=20, filename='ml_1000user_1000item.npy')
print(U.shape)
np.save('ml_1000user_d20.npy', U)
